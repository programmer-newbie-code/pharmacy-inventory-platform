...
class ExcelReportService {
  ...
  List<int> generateSalesReport({
    ...
    summarySheet.appendRow([
      TextCellValue(
        'PharmaLoka — Pharmacy Inventory Platform — Sales & Financial Report',
      ),
    ]);
    summarySheet.appendRow([
      TextCellValue(
  ...
  List<int> generateBestSellingMedicinesReport({
    ...
    sheet.appendRow([
      TextCellValue(
        'PharmaLoka — Pharmacy Inventory Platform — Best-Selling Medicines Report',
      ),
    ]);
    sheet.appendRow([
      TextCellValue(
  ...
  List<int> generateProcurementReport({
    ...
    sheet.appendRow([
      TextCellValue(
        'PharmaLoka — Pharmacy Inventory Platform — Procurement Report',
      ),
    ]);
    sheet.appendRow([
      TextCellValue(
  ...
  List<int> generateCashMovementReport({
    ...
    sheet.appendRow([
      TextCellValue(
        'PharmaLoka — Pharmacy Inventory Platform — Cash Movement Report',
      ),
    ]);
    sheet.appendRow([
      TextCellValue(
